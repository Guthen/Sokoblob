...
function Label:construct( text, x, y )
...
function Label:drawText( text, off_x, off_y )
    ...
    love.graphics.printf( text, self.x + off_x + self.w - limit, self.y + off_y - love.graphics.getFont():getHeight() / 2, limit, self.text_align )
end